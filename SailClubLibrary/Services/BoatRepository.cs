    ...
    public class BoatRepository : IBoatRepository
    {
        ...
        public List<Boat> FilterBoats(string filterCriteria)
        {
            ...
            foreach (Boat b in _boats.Values)
            {
                ...
                else if (b.Id.ToString().Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.EngineInfo.Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.Draft.ToString().Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.Width.ToString().Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.YearOfConstruction.Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.Length.ToString().Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.TheBoatType.ToString().Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
                else if (b.SailNumber.Contains(filterCriteria, StringComparison.CurrentCultureIgnoreCase))
                {
                    filteredBoats.Add(b);
                }
            }
